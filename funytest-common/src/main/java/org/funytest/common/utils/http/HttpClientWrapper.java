...
public class HttpClientWrapper {
	...
	public ResponseStatus sendRequest(String url) throws HttpException, IOException {
		return this.sendRequest(url, "UTF-8", HttpMethod.GET, null, null);
	}
	
	public ResponseStatus sendRequest(String url, Map<String, String> headers) throws HttpException, IOException {
		return this.sendRequest(url, "UTF-8", HttpMethod.GET, null, headers);
	}
	...
	public ResponseStatus sendRequest(String url, String urlEncoding) throws HttpException, IOException {
		return this.sendRequest(url, urlEncoding, HttpMethod.GET, null, null);
	}
	...
	public ResponseStatus postNV(String url) throws HttpException, IOException {
		return this.sendRequest(url, "UTF-8", HttpMethod.POST, null, null);
	}

	public ResponseStatus postNV(String url, String contentType) throws HttpException, IOException {
		return sendRequest(url, "UTF-8", HttpMethod.POST, contentType, null);
	}
	 ...
	 * @throws IOException
	 */
	public ResponseStatus sendRequest(String urlstr, String urlEncoding, HttpMethod bodyType, String contentType, Map<String, String> headers)
...
//		
		...
		try {
			...
			if (headers != null) {
				for (String key : headers.keySet()) request.addHeader(key, headers.get(key));
			}
	...
	private void getResponseStatus(HttpEntity entity, ResponseStatus ret) throws IOException {
		...
		ret.setResponseBody(new String(ret.getContentBytes(),"UTF-8"));
	}

	public ResponseStatus postEntity(String url, Map<String, String> headers) throws HttpException, IOException {
		return this.postEntity(url, "UTF-8", headers);
	}
	 ...
	 * @throws IOException
	 */
	public ResponseStatus postEntity(String url, String urlEncoding, Map<String, String> headers) throws HttpException, IOException {
		if (url == null)
			return null;
